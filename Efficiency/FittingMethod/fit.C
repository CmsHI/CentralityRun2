...
TH1* scale(string var, TTree* nt, double s = 1, TCut cut = "", bool doDiffBins=0, int nbins = 2000, double xmin=0, double xmax=4000, double normRangeMin=200, double normRangeMax=3500, bool doMCreweight=false){
