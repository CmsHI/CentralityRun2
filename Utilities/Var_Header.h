...
const Double_t VarW[NVar] = {40, 2, 2, 2, 2, 40, 2, 2, 2, 2, 4, 5, 10};
									//width of bin
const Int_t Nnorm = 6;
const Double_t NormRangeMin[NVar][Nnorm] = {{1000, 500, 50, 1000, 500, 50},
														{500, 250, 40, 500, 250, 40},
														{200, 100, 20, 200, 100, 20},
														{500, 250, 40, 500, 250, 40},
														{200, 100, 20, 200, 100, 20},
														{1000, 500, 50, 1000, 500, 50},
														{500, 250, 40, 500, 250, 40},
														{500, 250, 40, 500, 250, 40},
														{200, 100, 50, 200, 100, 50},
														{300, 100, 50, 300, 100, 50},
														{500, 200, 50, 500, 200, 50},
														{20000, 10000, 1000, 20000, 10000, 1000},
														{10000, 1000, 500, 10000, 1000, 500}
														};
														//minimum of normaization range
const Double_t NormRangeMax[NVar][Nnorm] = {{3000, 3000, 3000, 4000, 4000, 4000},
														...
														{100000, 100000, 100000, 120000, 120000, 120000},
														{60000, 60000, 60000, 90000, 90000, 90000}
														};
